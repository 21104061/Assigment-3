...
#To search a student's name by his/her SID
    
SID_To_Search = int(input("Search SID:- "))
print("name:-")    
print(student_info[SID_To_Search])
print("Completed")
print()
...
term2 = int(input("Enter Second Number:- "))
...
while(n == "y"):
    ...
    print(series)
    n = input("Enter y to Continue or n to Stop:- ")
print("list of fibonacci series:-")
print(series)
print()
#To Find the Average of The fibonacci series
sum = 0
for i in series:
    sum = sum + i
print("Average:-")
...
print("Question 8(c)")
print()
Set = (Set1&Set2)|(Set2&Set3)|(Set1&Set3)
print(Set)
print("Compeleted")
print()
